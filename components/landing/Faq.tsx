const FAQS = [
  ...
  },
  {
    ...
    a: "Транскрипты не используются OpenAI для дообучения моделей (мы используем API без opt-in). История хранится у тебя локально, пока мы не подключим синхронизацию с аккаунтом.",
  },
  {
  ...
  },
  {
    ...
    a: "Да, в один клик из настроек. Локальную историю можно стереть прямо в браузере (вкладка «Все интервью» → «Удалить»).",
  },
];
