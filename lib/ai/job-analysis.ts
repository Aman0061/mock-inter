...
export const jobAnalysisSchema = z.object({
  ...
  summary: z
    .string()
    .describe(
      "Одно-два предложения: за что отвечает PM на этой роли и какие у него стейкхолдеры."
    ),
  competencies: z
    .array(
      z.object({
...
export const JOB_ANALYSIS_SYSTEM_PROMPT = `Ты — опытный senior PM и рекрутер, специализирующийся на продактах в СНГ и FAANG.

На вход — текст вакансии Product Manager. Твоя задача: извлечь структурированные данные, которые помогут кандидату подготовиться.
